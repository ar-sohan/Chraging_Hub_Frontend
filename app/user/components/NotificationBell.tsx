  ...
  return (
    <details className="relative">
      <summary aria-label={"Notifications, " + unread + " unread"}
        className="flex cursor-pointer list-none items-center gap-1 rounded-lg p-2 text-gray-700 hover:bg-gray-100 [&::-webkit-details-marker]:hidden">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
          <path d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9M10 21h4" />
        </svg>
        {unread > 0 && <span className="dui-badge dui-badge-primary dui-badge-sm">{unread}</span>}
      </summary>
